                  ...
                  _createClass(Drawer, [{
                    ...
                    value: function open(event) {
                      ...
                      if(document.querySelector('#shopify-section-header')){
                        ...
                        if( document.querySelector('#shopify-section-telenor-header')){
                          document.querySelector('#shopify-section-telenor-header').style.zIndex = ''; // Ugly hack                        
                        }
                      }
                ...
                var ProductItemColorSwatch = /*#__PURE__*/function () {
                  ...
                  _createClass(ProductItemColorSwatch, [{
                    ...
                    value: function _colorChanged(event, target) {
                      ...
                      var BtnUrl = target.getAttribute('data-url');
                      productItem.querySelector('.ProductItem__ImageWrapper').setAttribute('href', variantUrl);
                      productItem.querySelector('.add-btn').setAttribute('href', BtnUrl );
   ...
   */
       ...
       */
                    ...
                    value: function _onVariantChanged(event) {
                      ...
                      // on variant change event croos add 
   ...
   */
       ...
       */
                    ...
                    value: function _updateProductPrices(newVariant, previousVariant) {
                      var productMetaPrices = this.element.querySelector('.ProductMeta__PriceList'),
                        ...
                        var Meta_price = $('.ProductMeta__PriceList').attr("data-currency");
                      ...
                      if (!newVariant) {
                        ...
                        if (newVariant['compare_at_price'] > newVariant['price']) {
                          ...
                          productMetaPrices.innerHTML += `<span class=\"ProductMeta__Price Price Price--compareAt Text--subdued u-h4\" data-money-convertible>${Meta_price}` .concat(Currency.formatMoney(newVariant['compare_at_price'], currencyFormat), "</span>");
                        } else {
       ...
       */
                    ...
                    value: function _updateAddToCartButton(newVariant) {
                      var addToCartButton = this.element.querySelector('.ProductForm__AddToCart'),
                          vimlabutton = this.element.querySelector(".Vimla_second"),
                          vimlafstbutton = this.element.querySelector(".Vimla_button"),
                          shopifyPaymentButton = this.element.querySelector('.shopify-payment-button');

                      // NEW VIMLA BUTTON CODE START
                        if (vimlabutton) {
                          vimlabutton.classList.remove('Button--secondary');
                          vimlabutton.classList.remove('Button--primary');
                          
                          if (!newVariant) {
                            vimlabutton.setAttribute('disabled', 'disabled');
                           // vimlabutton.removeAttribute('data-action');
                      
                            vimlabutton.classList.add('Button--secondary');
                            vimlabutton.innerHTML = window.languages.productFormUnavailable;
                          } else {
                            if (newVariant['available']) {
                          
                              vimlabutton.removeAttribute('disabled');
                              vimlabutton.classList.add(vimlabutton.getAttribute('data-use-primary-button') === 'true' ? 'Button--primary' : 'Button--secondary');
                            //  vimlabutton.setAttribute('data-action', 'add-to-cart');
                      
                              if (undefined === this.options['showPriceInButton'] || this.options['showPriceInButton']) {
                                vimlabutton.innerHTML = "\n            <span>".concat(window.languages.productFormAddToCart, "</span>\n            <span class=\"Button__SeparatorDot\"></span>\n            <span data-money-convertible>").concat(Currency.formatMoney(newVariant['price'], window.theme.moneyFormat), "</span>\n          ");
                              } else {
                                vimlabutton.innerHTML = "<span>".concat(window.languages.productFormAddToCart, "</span>");
                              }
                            } else {
                              vimlabutton.setAttribute('disabled', 'disabled');
                              ...
                              vimlabutton.classList.add('Button--secondary');
                             // vimlabutton.removeAttribute('data-action');
                              vimlabutton.innerHTML = window.languages.productFormSoldOut;
                            }
                          }
                        }

                        if (vimlafstbutton) {
                          vimlafstbutton.classList.remove('Button--secondary');
                          vimlafstbutton.classList.remove('Button--primary');
                          
                          if (!newVariant) {
                            vimlafstbutton.setAttribute('disabled', 'disabled');
                          //  vimlafstbutton.removeAttribute('data-action');
                      
                            vimlafstbutton.classList.add('Button--secondary');
                            vimlafstbutton.innerHTML = window.languages.productFormUnavailable;
                          } else {
                            if (newVariant['available']) {
                          
                              vimlafstbutton.removeAttribute('disabled');
                              vimlafstbutton.classList.add(vimlafstbutton.getAttribute('data-use-primary-button') === 'true' ? 'Button--primary' : 'Button--secondary');
                             // vimlafstbutton.setAttribute('data-action', 'add-to-cart');
                      
                              if (undefined === this.options['showPriceInButton'] || this.options['showPriceInButton']) {
                                vimlafstbutton.innerHTML = "\n            <span>".concat(window.languages.productFormAddToCart, "</span>\n            <span class=\"Button__SeparatorDot\"></span>\n            <span data-money-convertible>").concat(Currency.formatMoney(newVariant['price'], window.theme.moneyFormat), "</span>\n          ");
                              } else {
                                vimlafstbutton.innerHTML = "<span>".concat(window.languages.productFormAddToCart, "</span>");
                              }
                            } else {
                              vimlafstbutton.setAttribute('disabled', 'disabled');
                              ...
                              vimlafstbutton.classList.add('Button--secondary');
                             // vimlafstbutton.removeAttribute('data-action');
                              vimlafstbutton.innerHTML = window.languages.productFormSoldOut;
                            }
                          }
                        }
                      // NEW VIMLA BUTTON CODE END
       ...
       */
                    ...
                    value: function _addToCart(event) {
                      ...
                      var formElement = this.element.querySelector('.ProductForm');
                      ...
                      fetch("".concat(window.routes.cartAddUrl, ".js"), {
                        ...
                        if (response.ok) {
                             var a = "done";
                              //           accessories functionality : start -----
                              var url = $(addToCartButton).parent('#location').data('target');
                              console.log(url);
                  
                              if ( typeof $(addToCartButton).parent('#location').data('target') !== 'undefined') {
                     ...
                     document.querySelector('.ProductForm').reset();
                      $("#temp-code").removeAttr('value');
                      $("#action-code").removeAttr('value');
                    }
       ...
       */
                    ...
                    value: function _openSearch() {
                      ...
                      if(document.querySelector('#shopify-section-header')){
                        ...
                        if( document.querySelector('#shopify-section-telenor-header')){
                          document.querySelector('#shopify-section-telenor-header').style.zIndex = 10;
                        }
                      }
                    }
                    /**
                      ...
                      var onTransitionEnd = function onTransitionEnd(event) {
                        if (event.propertyName === 'visibility') {
                          if(document.querySelector('#shopify-section-header')){
                            ...
                            if( document.querySelector('#shopify-section-telenor-header')){
                              document.querySelector('#shopify-section-telenor-header').style.zIndex = '';
                            }
                          }
                  ...
                  _createClass(FeaturedCollectionsSection, [{
                    ...
                    value: function _setupAnimation() {
                      ...
                      if (this.options['layout'] === 'grid' && window.theme.showElementStaggering) {
                        ...
                        if (productList) {
                          this.timeline.fromTo(productList, 0, {
                            autoAlpha: 0,
                            y: 25
                          }, {
                            autoAlpha: 1,
                    ...
                    value: function _reveal(results) {
                      ...
                      this.timeline.staggerFromTo(toReveal, 0, {
                        autoAlpha: 0,
                        y: 25
                      }, {
                        autoAlpha: 1,
                    ...
                    value: function _openPocketZoom(popover) {
                      ...
                      fastdom.mutate(function () {
                        ...
                        if(document.getElementById('shopify-section-header')){
                          ...
                          if( document.querySelector('#shopify-section-telenor-header')){
                            document.getElementById('shopify-section-telenor-header').style.cssText = 'transform: translateY(-100%); transition: transform 0.3s ease-in-out;';
                          }
                        }
                    ...
                    value: function _closePocketZoom() {
                      ...
                      fastdom.mutate(function () {
                        if(document.getElementById('shopify-section-header')){
                          ...
                          if( document.querySelector('#shopify-section-telenor-header')){
                            document.getElementById('shopify-section-telenor-header').style.cssText = 'transform: translateY(0); transition: transform 0.3s ease-in-out 0.3s;';
                          }
                        }
                  ...
                  _createClass(SlideshowSection, [{
                    ...
                    value: function _slideEnter(slide) {
                      ...
                      if (this.slideshow.flickityInstance.options.autoPlay && this.slideshow.flickityInstance.player.state === 'paused') {
                        ...
                        var main_div = document.querySelectorAll('.Slideshow__Carousel');
                      
                      for(var i = 0, j = main_div.length; i < j; i++) {
                         if (main_div[i].classList.contains('telenorgreenroom')){
                      ...
                      if (content) {
                        this.timeline.fromTo(content, this.shouldAnimate ? 0 : 0, {
                          autoAlpha: 0,
                          y: 30
                        }, {
                          autoAlpha: 1,
                      ...
                      if (buttonWrapper) {
                        this.timeline.fromTo(buttonWrapper, this.shouldAnimate ? 0 : 0, {
                          autoAlpha: 0,
                          y: 20
                        }, {
                          autoAlpha: 1,
     ...
     */
                  ...
                  (function () {
                    var windowWidth = window.innerWidth,
                        ...
                        headerSectionnew = document.getElementById('shopify-section-telenor-header');
                    ...
                    window.addEventListener('resize', function () {
                      ...
                      fastdom.mutate(function () {
                        ...
                        }else if(headerSectionnew){
                          document.documentElement.style.setProperty('--header-height', headerSectionnew.clientHeight + 'px');
                        }
...
// this code for chat icon position change on product page : Start
...
waitForElm('#dummy-chat-button-iframe').then((elm) => {
  ...
  $(elm).contents().find("body").on('mouseup', function(event) {
    console.log(event, 'IFRAME CLICKED');
    waitForElm('#ShopifyChat').then((elm) => {
      // Select the target node that you want to observe
      const targetNode = document.getElementById('ShopifyChat');
      ...
      const observer = new MutationObserver((mutationsList, observer) => {
        ...
        for (let mutation of mutationsList) {
          ...
          if (mutation.type === 'childList') {
            ...
            if(elm.parentElement.classList.contains('btn--cls')){
              elm.parentElement.classList.remove('btn--cls');
              console.log("CLASS HAS BEEN ADDED");
            }else{
              elm.parentElement.classList.add('btn--cls');
...
// this code for chat icon position change on product page : end
